# Other useful Python packages for Oceanographic/meteorological data analysis

Here are some packages which I haven't talked about in the tutorial, but are great tools that you should know they exists.
